...
app.post("/webhook", async (req, res) => {
  ...
  // Validação HMAC desabilitada temporariamente — reintroduzir após
  // confirmar que nodeCrypto está disponível no ambiente de produção.
  // Rate limiting ainda está ativo como proteção básica.
